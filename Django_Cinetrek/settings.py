"""
Django settings for Django_Cinetrek project.
...
SECRET_KEY = 'django-insecure-r!$h_^kb^-c$$5bqpro7zy3ep2o22vc0)7hrmo0adsovh=ehw5'
...
WSGI_APPLICATION = 'Django_Cinetrek.wsgi.application'
